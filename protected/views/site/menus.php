...
$(function(){
	...
	$('#search_btn').click(function(){
			...
			var url = "<?php echo Yii::app()->createUrl('site/menus');?>";
    ...
    <div id="pAccount" class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          ...
          <a href="<?php echo Yii::app()->createUrl('site/MenusForm');?>" class="button" style="float:left;margin-left:10px;margin-top:7px;">新增</a>
        </ul>
        <div class="clear"></div>
      </div>
        ...
        <div class="tab-content default-tab" id="tab1">
          <table style="width:100%;">
            ...
            <tfoot>
              <tr>
              	<td>
                	<a href="<?php echo Yii::app()->createUrl('site/MenusForm');?>" class="button" style="float:left;margin-left:10px;">新增</a>
                </td>
                <td colspan="7">
            ...
            <tbody>
               <?php if(isset($data)):?>
		              ...
		              <tr>
		                ...
		                <td>
		                  <a href="<?php echo Yii::app()->createUrl('site/MenusForm',array('id' => $v['id']));?>" title="Edit"><img src="<?php echo Yii::app()->baseUrl;?>/assets/images/icons/pencil.png" alt="Edit" /></a>
		                  <a href="javascript:void(0);" _href="<?php echo Yii::app()->createUrl('menus/deleteAjax',array('id' => $v['id']));?>"  class="remove_row_ajax"><img src="<?php echo Yii::app()->baseUrl;?>/assets/images/icons/cross.png" alt="Delete" /></a>
		                </td>
		              </tr>
              		<?php endforeach;?>
              <?php endif;?>
